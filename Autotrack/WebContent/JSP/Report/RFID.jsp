...
%>
<td align="left" class="report_border" style="padding-left: 10px;"><img alt="Engine Off" src="../images/off.png"></td>
<%
}
else
{
	halt_time="Running";
%>
	<td align="left" class="report_border" style="padding-left: 10px;"><img alt="Engine On" src="../images/on.png"></td>
<%
}
%>

<td align="left" class="report_border"><%=mile %></td>
...
<td align="center" class="report_border"><%=fence %></td>
<td align="left" class="report_border"><%=fuel %></td>
<%

%>
	
	<td align="left" class="report_border"><%=halt_time %></td>
