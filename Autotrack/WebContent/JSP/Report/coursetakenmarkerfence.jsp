...
<body onunload="GUnload()" onload="directions()"> 
	...
	<div class="content_bg"><span class="content_headning">Out of Fence</span></div><br/>
 ...
 <div class="posts">
   ...
   <!--  <tr><td style="background-color: #8685F7"></td><td></td><td>Defined Route</td></tr> -->
    ...
    <div id="distance_travelled" class="posts">
				...
				<%
				String customer_name=null,vehicle_number=null,driver_name=null;
				...
				rst = stmt.executeQuery("select latitude_value ,longitude_value from tracking where imei_no='"+imeinumber+"' and date_time >='"+startdate+"' and date_time <= '"+enddate+"' and alarm_type=42");
					...
					while(rst.next()){
						...
						if(counter==2 && previouslatitude<currentlatitude)
						{
							direction="North";
						}
						else if(counter==2 && previouslatitude > currentlatitude)
						{
							direction="South";
						}
