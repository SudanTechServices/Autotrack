<%@ page language="java" contentType="text/html; charset=UTF-8"
    ...
    String[] select = request.getParameterValues("s_id"); 	
...
<html>
  ...
  <div id="loading">
    ...
    var url = "UDR_Standard.jsp?vehicle_number="+vehicle_number+"&standard="+standard+"";  //the Next page you want to display...
