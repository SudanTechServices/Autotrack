...
%>
 <script type="text/javascript">
	...
	{
	   	document.pdf.action="Fuel_daily_Report_PDF.jsp?imeinumber="+imeinumber+"";
		document.pdf.submit();
	}
	 function redirect_to_excel(imeinumber)
	{
		document.pdf.action="/Autotrack/Fuel_Daily_Excel?imeinumber="+imeinumber+"";
		document.pdf.submit();
	} 
	</script> 
	</head>    
	<body>
<div class="content_bg"><span class="content_headning">Fuel Today's Grid</span></div>
...
rs = st.executeQuery("SELECT latitude_value,longitude_value,fuel,date_time,engine_status FROM tracking WHERE imei_no ='"+imeinumber+"' and date_time>='"+startdate+"' and date_time<='"+enddate+"'");
 if(rs.next())
{
...
if(fuel_from_db==0.00)
{
	...
	<td align="left" class="report_border"><img src="../../images/off.png" alt="Engine is Off"></td> 
	</tr>
	<tr>
	<%
	}
