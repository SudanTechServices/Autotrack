...
response.setContentType("application/pdf");
	String filename="route_report.pdf";
...
try{   
      ...
      Font myContentStyle1=new Font(Font.TIMES_ROMAN);
 	   ...
 	   document.add(image);
	        ...
	        Paragraph p1=new Paragraph("Report for Route Number : "+route+"",myContentStyle);
 	  ...
 	  /* PdfPCell cell = new PdfPCell(new Paragraph("Report for Route Number : "+route+"",myContentStyle));
				...
				//gives number of locations
								...
								if(select[i].equalsIgnoreCase("location")){
									...
									while(rs.next()){
										...
										Paragraph p3=new Paragraph("No of Locations :  "+no_of_locations+"",myContentStyle);
								        p3.setSpacingAfter(10);
								        p3.setIndentationLeft(51);
								     
										document.add(p3);

/* PdfPCell cell1 = new PdfPCell(new Paragraph("No of Locations :  "+no_of_locations+"",myContentStyle));
		...
		table.addCell(cell1); */
								...
								if(select[i].equalsIgnoreCase("pick_point")){
									...
									while(rs.next()){
										...
										Paragraph p4=new Paragraph("No of Pick Points : "+no_of_pickpoint+"",myContentStyle);
								        p4.setSpacingAfter(10);
								        p4.setIndentationLeft(51);
								     
										document.add(p4);
										
										
										
										/* PdfPCell cell2 = new PdfPCell(new Paragraph("No of Pick Points : "+no_of_pickpoint+"",myContentStyle));
