  ...
  <div id="loading">
          <div class="loading-indicator" style="padding-left: 10px;">
             <center><div><img alt="" src="../../images/loading1.gif"> <br><br>
         		Loading Speed Report .....</div></center>
         	 </div>
     </div>
     ...
     var url = "speed_exception_report_grid.jsp?vehicle_number="+vehno+"&start_date="+start+"&end_date="+end+""; //the Next page you want to display...
