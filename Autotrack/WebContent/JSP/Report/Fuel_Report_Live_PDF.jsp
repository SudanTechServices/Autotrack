...
response.setContentType("application/pdf");
	String filename="fuel_live_report.pdf";
...
try{   
   ...
   // Image headImage = Image.getInstance("GetImagePath");
    ...
    //document.add(new Paragraph("Speed Report",myContentStyle));
              ...
              Paragraph paragraph1=new Paragraph("Fuel Live Report for : "+vehicle_number+"",myContentStyle);
    ...
    /*  PdfPCell cell = new PdfPCell(new Paragraph("Fuel Live Report for : "+vehicle_number+"",myContentStyle));
