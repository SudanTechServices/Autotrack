...
try {								 	
	...
	response.setHeader("Content-Disposition", "attachment; filename=rondT_trip_report.xls");
					...
					{ // off to on difference: 
						...
						{													
							...
							//----------------Putting all the values in map--------------//		
											...
											if(src_sub_lat.equals(lat_subString) && latCounter!=1 ){  																						
...
//  wb.wirte(response.getOutputStream());
