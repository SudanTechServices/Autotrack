...
<center>
<div class="content_bg"><span class="content_headning">User Report</span></div>
...
rs = st.executeQuery("SELECT * FROM tracking WHERE imei_no ='"+IMEI+"' and date_time>='"+startdate+"' and date_time<='"+enddate+"'");
