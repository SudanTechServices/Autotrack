...
response.setContentType("application/pdf");
	String filename="Standard_report.pdf";
...
try{   
      ...
      Font myContentStyle1=new Font(Font.TIMES_ROMAN);
 	      ...
 	      document.add(image);
 	     	...
 	     	Paragraph p1=new Paragraph("Report for Standard : "+standard+"",myContentStyle);
 ...
 /* 
 	    PdfPCell cell = new PdfPCell(new Paragraph("Report for Standard : "+standard+"",myContentStyle));
				...
				if(select[i].equalsIgnoreCase("pick_point")){
								...
								if(select[i].equalsIgnoreCase("pick_point")){
									...
									while(rs.next()){
										...
										Paragraph p4=new Paragraph("No of Different Routes "+route_number+"",myContentStyle);
