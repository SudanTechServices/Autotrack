...
<% String IMEI=(String)session.getAttribute("IMEI");
					IMEI=IMEI.concat("-cam2");
					System.out.println("IMEI "+IMEI);
%>
<script type="text/javascript">
function showframe(){
	
	document.getElementById("frame").innerHTML = '<iframe src="http://182.72.167.37:8080/cmsgps/monitor/demo/<%=IMEI%>.html" type="application/x-shockwave-flash" allowfullscreen="true" allowScriptAccess="always" width="325" height="225" scrolling="auto" name="iframe" ></iframe>';
}
