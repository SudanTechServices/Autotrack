...
<tr>
<td>
<table cellpadding="4" cellspacing="0" class="table_content" style="width: 40%; background-color: #f8f8f8;">
<tr>
<td>
TCSS ID Number
</td>
<td>:</td>
<td>
<input type="text" name="tcss_id_number" size="25" />
</td>
</tr>
<tr>
<td>
...
<td>:</td>
<td>
<input type="text" name="tcss_name" size="25" />
</td>
</tr>
<tr>
<td>
...
<td valign="top">:</td>
<td>
<textarea name="address" rows="3" cols="20" style="resize: none;"></textarea>
</td>
</tr>
<tr>
<td>Date Of Birth</td>
...
<td>:</td>
<td>
 <select id="dropdown" name="doj_dropdown_month">
<option>Month</option>
<option>Jan</option>
<option>Feb</option>
<option>Mar</option>
...
<option>Dec</option>
 ...
 <select id="dropdown" name="doj_dropdown_day">
<option >Day</option>
 ...
 <select id="dropdown" name="doj_dropdown_year" >
<option>Year</option>
...
<td>:</td>
<td>
<input type="text" name="experience" size="25"/>
</td>
</tr>
<tr>
<td>
...
<td>:</td>
<td>
<input type="text" name="Route_number" size="25" />
</td>
</tr>
<tr>
	<td colspan="3"></td>
...
<tr>
	...
	<td colspan="2" align="center"><input type="button" class="submit" value="Save"  onclick="tcss_info_save();">&nbsp;&nbsp;
