...
function noBack() { window.history.forward(); }
	function delete1()
	{
		...
		document.BusRouteInfo.action="/Autotrack/ControllerServlet/BusRouteDeleteService?route_number="+route_number;
...
<div class="content_bg"><span class="content_headning">Route Delete</span></div>
...
<input class="groovybutton" type="button" class="submit" value="Delete" onclick="delete1();"></td></tr>
