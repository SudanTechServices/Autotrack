...
function noBack() { window.history.forward(); }
	...
	function search()
	{
		...
		if(route_number == "")
			{
			alert("Enter The Route Number");
			}
		else
			{
		
		document.BusRouteInfo.action="../JSP/routeupdate.jsp";
...
<tr>
<td colspan="3" style="color: red">* Enter the route Number and Update</td></tr>
<tr height=15px>
<td>
Route Number   
</td>
...
<td></td>
<td>
<input class="groovybutton" type="button" value="Search By Route Number" onclick="search();">
</td></tr>
