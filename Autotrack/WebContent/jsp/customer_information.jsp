...
{
    window.location.href = "customer_search.jsp";
}
...
<div class="mainwrapper">
    ...
    <div class="rightpanel">
        ...
        <div class="pagetitle">
        	<h1>Customer Information</h1> <span>This is the new Customer creation page</span>
        </div><!--pagetitle-->
        
        <div class="maincontent">
        	<div class="contentinner">
            	<h4 class="widgettitle nomargin shadowed">Register Cutomer Information</h4>
                <div class="widgetcontent bordered shadowed">
                	...
                	<form class="stdform" action="#" method="post">
                        ...
                        <p>
                            ...
                            <span class="field"><input type="text" name="customerid" class="input-xlarge" placeholder="Customer ID" /></span>
                        </p>  
                        
                        <p>
                        	<label>Customer Name</label>
                            <span class="field"><input type="text" name="customername" class="input-xlarge" placeholder="Customer Name" /></span>
                        </p>
                        
                         <p>
                        	<label>Contact Person  </label>
                            <span class="field"><input type="text" name="contactperson" class="input-xlarge" placeholder="Contact Person " /></span>
                        </p>
                        ...
                        <p>
                         ...
                         <p>
                            ...
                            <span class="field"><input type="text" name="nooflicence" class="input-xlarge" placeholder="No. of Licence" /></span>
                        </p>
