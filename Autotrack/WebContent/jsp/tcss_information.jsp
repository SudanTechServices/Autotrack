...
{
    window.location.href = "tcss_search.jsp";
}
...
<div class="mainwrapper">
    ...
    <div class="rightpanel">
        ...
        <div class="pagetitle">
        	<h1>TCSS Information</h1> <span>This is the new TCSS creation page</span>
        </div><!--pagetitle-->
        
        <div class="maincontent">
        	<div class="contentinner">
            	<h4 class="widgettitle nomargin shadowed">Register TCSS Information</h4>
                <div class="widgetcontent bordered shadowed">
                	...
                	<form class="stdform" action="#" method="post">
                        ...
                        <p>
                            ...
                            <span class="field"><input type="text" name="tcssudnumber" class="input-xlarge" placeholder="TCSS ID Number" /></span>
                        </p>
                        
                                              
                        <p>
                        	<label>Name</label>
                            <span class="field"><input type="text" name="contact number" class="input-xlarge" placeholder="Contact Number" /></span>
                        </p>
                        
                        <p>
                        	<label>Gender</label>
                            <span class="formwrapper">
                            	<input type="radio" name="radiofield" /> Male &nbsp; &nbsp;
                         ...
                         <p>
                            ...
                            <span class="field"><input type="text" name="contactnumber" class="input-xlarge" placeholder="Contact Number" /></span>
                        </p>
                        
                         <p>
                        	<label>Address</label>
                            <span class="field"><textarea cols="80" rows="4" placeholder="Address" class="span3"></textarea></span> 
                        </p>
                        
                        <p>
                        	<label>Date Of Birth</label>
                            <input id="datepicker" type="text" name="date" placeholder="Date of Birth" class="input-small" /> &nbsp; <small><em>mm / dd / yyyy</em></small>
                         ...
                         <p>
                            ...
                            <input id="datepicker1" type="text" name="date" placeholder="Date of Joining" class="input-small" /> &nbsp; <small><em>mm / dd / yyyy</em></small>
                            <div class="widgetsource">
                            	<div class="divider15"></div>
                            	<pre class="prettyprint linenums">&lt;input id=&quot;datepicker&quot; type=&quot;text&quot; name=&quot;date&quot; /&gt;</pre>
                              <div class="divider15"></div>
                         ...
                         <p>
                            ...
                            <span class="field"><input type="text" name="yearsofexperience " class="input-xlarge" placeholder="Years Of Experience " /></span>
                        </p>                        
                        ...
                        <p>
                            ...
                            <select name="select" class="uniformselect">
                                ...
                                <option value="">TN 76 U 3083</option>
                                <option value="">TN 76 Z 3545</option>
                            </select>                            
                            </span>
                        </p>
                         ...
                         <p>
                            ...
                            <span class="field"><input type="text" name="routenumber " class="input-xlarge" placeholder="Route Number" /></span>
                        </p>              
                                                
                        <p class="stdformbutton">
                            <button class="btn btn-success">Save</button>
                            <button type="reset" class="btn" onclick="return btntest_onclick()">Update / Delete</button>
                        </p>
