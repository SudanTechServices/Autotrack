    ...
    <div class="rightpanel">
        ...
        <div class="breadcrumbwidget">        	
        	<ul class="breadcrumb">
                ...
                <li class="active">SBLT Trip Sheet</li>
            </ul>
        </div><!--breadcrumbs-->
        <div class="pagetitle">
        	<h1>SBLT Trip Sheet</h1> <span>This is the new trip sheet creation page</span>
        </div><!--pagetitle-->
        	...
        	<div class="contentinner">
                ...
                <form class="stdform" action="#" method="post">
                		...
                		<p>
                            ...
                            <span class="field"><input type="text" name="tripsheetfor" class="input-medium" placeholder="Trip Sheet For" /></span>
                        </p>
                        
                        <p>
                        	<label>Day</label>
                            <span class="field"><input type="text" name="day" class="input-medium" placeholder="Day" /></span>
                        </p>
