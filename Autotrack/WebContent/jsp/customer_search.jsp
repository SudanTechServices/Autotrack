...
{
    window.location.href = "vehicle_search.jsp";
}
    ...
    <div class="rightpanel">
        ...
        <div class="maincontent">
        	<div class="contentinner">
            	<h4 class="widgettitle nomargin shadowed">Search Driver Information</h4>
                <div class="widgetcontent bordered shadowed">     
                
                <form class="stdform" action="customer_information.jsp" method="post">
                
                        <p class="text-error">* Please Enter the Existing Customer ID </p>               	
