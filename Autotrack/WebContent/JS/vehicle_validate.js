function vehicleFormValidator(){
	...
	var vechile_mfg = document.VehicleInfo.vechile_mfg.value;
	var fuel_capacity = document.VehicleInfo.fuel_capacity.value;
	var max_speed = document.VehicleInfo.max_speed.value;
	var min_fuel_volt = document.VehicleInfo.min_fuel_volt.value;
	var max_fuel_volt = document.VehicleInfo.max_fuel_volt.value;
	...
	//Vehicle Manufacturer				
			if(isAlphanumeric(vechile_mfg, "Please enter a valid Vehicle MFG")){
					if(lengthRestriction(vechile_mfg, 2, 40,'Enter Within 10 characters')){  		
