...
public class UpdatePassword extends CommonService{
	public void run() throws ServletException, IOException{
		...
		String retypepassword = request.getParameter("newcpswd");
		String password="";
		String mailid = "";
		/* String question2 = "";
		String answer2 = ""; */
		...
		try{
			  ...
			  if(oldpassword.equals(password))
			  {
				  ...
				  st.executeUpdate("UPDATE  login_information SET password='"+retypepassword+"' WHERE password='"+oldpassword+"' and user_name='"+username+"'");
				  RequestDispatcher rd=request.getRequestDispatcher("/JSP/homepage.jsp?message=passwordupdated");
